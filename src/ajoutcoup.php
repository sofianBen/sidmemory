...
oci_bind_by_name($procedure, ':p_idjoueur', $_GET['idjoueur'],10);
oci_bind_by_name($procedure, ':p_carte1', $_GET['carte1'], 10);
oci_bind_by_name($procedure, ':p_carte2', $_GET['carte2'], 10);
